...
export default function MainMenu() {
  ...
  return (
    <View className="flex-1 bg-black justify-center items-center p-5">
      ...
      >
        <Text className="text-yellow-300 text-2xl text-center mb-5">Bosses</Text>
        <Image
                source={{ uri: "https://static0.gamerantimages.com/wordpress/wp-content/uploads/2023/11/elden-ring-bosses.jpg" }}
      ...
      <TouchableOpacity
        ...
        className="bg-gray-800 p-5 rounded-lg mb-5 w-full max-w-xs items-center"
      >
        <Text className="text-yellow-300 text-2xl text-center mb-5">Items</Text>
        <Image
                source={{ uri: "https://i.redd.it/7va0wvtbvj6d1.jpeg" }}
                className="w-full h-52 mb-4 "
                resizeMode="cover"
              />
